...
function replacer(initValue) {
    return function replaceDecorator(target, ctx) {
        console.log(target);
        console.log(ctx);
        // override value
...
var Person = function () {
    ...
    var Person = _classThis = /** @class */ (function () {
        function Person_1() {
            this.name = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _name_initializers, "Bob"));
        }
    ...
    (function () {
        ...
        _name_decorators = [replacer('John')];
        _greet_decorators = [autobin];
